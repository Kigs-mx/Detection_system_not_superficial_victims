...
#  gray = cv2.cvtColor(cv_image, cv2.COLOR_BGR2GRAY)
  ...
  cv_image = imutils.resize(cv_image, width=min(20, cv_image.shape[1]))
  cv2.imshow("Roi_1", cv_image)
  print "suscrito a roi 1"
...
def main(args):
  ...
  rospy.init_node('roi_monitor_1', anonymous=False)
