...
def color_presentation (cv_image):
  ...
  cv2.imshow("Color_thermal_roi_1_image", im_color)
#  cv2.waitKey(1)
...
def callback(data):
  cv2.namedWindow("Color_thermal_roi_1_image",1)
  cv2.moveWindow("Color_thermal_roi_1_image",450,350)
...
def main(args):
  ...
  rospy.init_node('color_roi_representation', anonymous=False)
