...
def color_presentation (cv_image):
  ...
  cv2.imshow("Color_thermal_roi_3_image", im_color)
#  cv2.waitKey(1)
...
def main(args):
  ...
  rospy.init_node('color_roi_3_representation', anonymous=False)
#  image_sub = rospy.Subscriber("camera/image",Image,callback)
  image_sub = rospy.Subscriber("rois_detected/rois_3",Image,callback)
